...
var inBrowser2, mark2, measure2, RE_ARGS2, hasSymbol2, generateFormatCacheKey2, friendlyJSONstringify2, isNumber2, isDate2, isRegExp2, isEmptyObject2, assign2, _globalThis2, getGlobalThis2, isArray3, isFunction2, isString3, isBoolean2, isObject3, objectToString2, toTypeString2, isPlainObject2, RANGE2;
var init_shared_esm_bundler3 = __esm({
  "node_modules/@intlify/core-base/node_modules/@intlify/shared/dist/shared.esm-bundler.js"() {
    ...
    hasSymbol2 = typeof Symbol === "function" && typeof Symbol.toStringTag === "symbol";
...
function handleFlatJson(obj) {
  ...
  for (const key in obj) {
    ...
    if (!key.includes(".")) {
      ...
      delete obj[key];
      if (isObject4(currentObj[subKeys[lastIndex]])) {
...
var hasOwnProperty2, isObject4, pathStateMachine, literalValueRE, cache;
var init_message_resolver_esm_bundler = __esm({
  "node_modules/@intlify/message-resolver/dist/message-resolver.esm-bundler.js"() {
    if (true)
      ;
    hasOwnProperty2 = Object.prototype.hasOwnProperty;
    isObject4 = (val) => val !== null && typeof val === "object";
    pathStateMachine = [];
    pathStateMachine[0] = {
      ["w"]: [0],
      ["i"]: [3, 0],
...
// node_modules/@intlify/runtime/node_modules/@intlify/shared/dist/shared.esm-bundler.js
var inBrowser3, mark3, measure3, hasSymbol3, isNumber3, isArray4, isFunction3, isString4, isObject5, objectToString3, toTypeString3, isPlainObject3, toDisplayString2;
var init_shared_esm_bundler4 = __esm({
  "node_modules/@intlify/runtime/node_modules/@intlify/shared/dist/shared.esm-bundler.js"() {
    inBrowser3 = typeof window !== "undefined";
    if (true) {
      const perf = inBrowser3 && window.performance;
      if (perf && perf.mark && perf.measure && perf.clearMarks && perf.clearMeasures) {
        mark3 = (tag) => perf.mark(tag);
    ...
    hasSymbol3 = typeof Symbol === "function" && typeof Symbol.toStringTag === "symbol";
    isNumber3 = (val) => typeof val === "number" && isFinite(val);
    isArray4 = Array.isArray;
    isFunction3 = (val) => typeof val === "function";
    isString4 = (val) => typeof val === "string";
    isObject5 = (val) => val !== null && typeof val === "object";
    ...
    toDisplayString2 = (val) => {
      return val == null ? "" : isArray4(val) || isPlainObject3(val) && val.toString === objectToString3 ? JSON.stringify(val, null, 2) : String(val);
    };
  }
});
...
function getPluralIndex(options) {
  const index = isNumber3(options.pluralIndex) ? options.pluralIndex : -1;
  return options.named && (isNumber3(options.named.count) || isNumber3(options.named.n)) ? isNumber3(options.named.count) ? options.named.count : isNumber3(options.named.n) ? options.named.n : index : index;
}
...
function createMessageContext(options = {}) {
  ...
  const pluralRule = isObject5(options.pluralRules) && isString4(locale) && isFunction3(options.pluralRules[locale]) ? options.pluralRules[locale] : pluralDefault;
  const orgPluralRule = isObject5(options.pluralRules) && isString4(locale) && isFunction3(options.pluralRules[locale]) ? pluralDefault : void 0;
  const plural = (messages) => messages[pluralRule(pluralIndex, messages.length, orgPluralRule)];
  const _list = options.list || [];
  const list = (index) => _list[index];
  const _named = options.named || {};
  isNumber3(options.pluralIndex) && normalizeNamed(pluralIndex, _named);
  const named = (key) => _named[key];
  function message(key) {
    const msg = isFunction3(options.messages) ? options.messages(key) : isObject5(options.messages) ? options.messages[key] : false;
    return !msg ? options.parent ? options.parent.message(key) : DEFAULT_MESSAGE : msg;
  }
  const _modifier = (name) => options.modifiers ? options.modifiers[name] : DEFAULT_MODIFIER;
  const normalize = isPlainObject3(options.processor) && isFunction3(options.processor.normalize) ? options.processor.normalize : DEFAULT_NORMALIZE;
  const interpolate = isPlainObject3(options.processor) && isFunction3(options.processor.interpolate) ? options.processor.interpolate : DEFAULT_INTERPOLATE;
  const type = isPlainObject3(options.processor) && isString4(options.processor.type) ? options.processor.type : DEFAULT_MESSAGE_DATA_TYPE;
  const ctx = {
    ["list"]: list,
    ["named"]: named,
    ["plural"]: plural,
    ["linked"]: (key, modifier) => {
      ...
      return isString4(modifier) ? _modifier(modifier)(msg) : msg;
    },
    ["message"]: message,
    ["type"]: type,
...
function createCompileError(code, loc, options = {}) {
  ...
  const msg = true ? format2((messages || errorMessages)[code] || "", ...args || []) : code;
...
function getWarnMessage(code, ...args) {
  return format2(warnMessages[code], ...args);
}
function getDefaultLinkedModifiers() {
  return {
    upper: (val) => isString3(val) ? val.toUpperCase() : val,
    lower: (val) => isString3(val) ? val.toLowerCase() : val,
    capitalize: (val) => isString3(val) ? `${val.charAt(0).toLocaleUpperCase()}${val.substr(1)}` : val
  };
}
...
function createCoreContext(options = {}) {
  ...
  const locale = isString3(options.locale) ? options.locale : "en-US";
  const fallbackLocale = isArray3(options.fallbackLocale) || isPlainObject2(options.fallbackLocale) || isString3(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : locale;
  ...
  const __datetimeFormatters = isObject3(internalOptions.__datetimeFormatters) ? internalOptions.__datetimeFormatters : new Map();
  const __numberFormatters = isObject3(internalOptions.__numberFormatters) ? internalOptions.__numberFormatters : new Map();
...
function getLocaleChain(ctx, fallback, start) {
  ...
  if (!chain) {
    ...
    const defaults = isArray3(fallback) ? fallback : isPlainObject2(fallback) ? fallback["default"] ? fallback["default"] : null : fallback;
...
function translate(context, ...args) {
  ...
  const defaultMsgOrKey = isString3(options.default) || isBoolean2(options.default) ? !isBoolean2(options.default) ? options.default : key : fallbackFormat ? key : "";
  ...
  if (!resolvedMessage && !(isString3(format3) || isMessageFunction(format3))) {
    if (enableDefaultMsg) {
      format3 = defaultMsgOrKey;
      cacheBaseKey = format3;
    }
  }
  if (!resolvedMessage && (!(isString3(format3) || isMessageFunction(format3)) || !isString3(targetLocale))) {
...
function resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn) {
  ...
  for (let i = 0; i < locales.length; i++) {
    ...
    if ((format3 = resolveValue(message, key)) === null) {
      format3 = message[key];
    }
    if (inBrowser2) {
    ...
    if (isString3(format3) || isFunction2(format3))
      break;
  ...
  return {
    ...
    onError: (err) => {
      ...
      if (true) {
        ...
        const codeFrame = err.location && generateCodeFrame3(source, err.location.start.offset, err.location.end.offset);
        const emitter = context.__v_emitter;
        if (emitter) {
...
var require_vue_cjs = __commonJS({
  "node_modules/vue/dist/vue.cjs.js"(exports) {
    ...
    var compileCache2 = Object.create(null);
...
var require_vue_i18n_cjs = __commonJS({
  "node_modules/vue-i18n/dist/vue-i18n.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var shared = (init_shared_esm_bundler2(), shared_esm_bundler_exports2);
    var coreBase = (init_core_base_esm_bundler(), core_base_esm_bundler_exports);
    var vue = require_vue();
    var VERSION2 = "9.1.9";
    var warnMessages2 = {
