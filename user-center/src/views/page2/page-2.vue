<template>
  ...
  <n-spin size="large" :show="loading">
    ...
    <n-space style="margin-top: 20px" justify="center">
      <!-- 书写提示 -->
      <help-button
        picSrc="https://tva1.sinaimg.cn/large/e6c9d24ely1h2btjn5prfj213w0loafr.jpg"
        place="left-start"
        heightValue="355"
      />
      <!-- 确认修改 -->
...
import { CreateInfo, GetInfo, UpdateInfo, DelFile } from "@/api/secondPage";
...
export default defineComponent({
  ...
  setup() {
    const apiBaseUrlUpload = API_BASE_URL + "/upload/2";
